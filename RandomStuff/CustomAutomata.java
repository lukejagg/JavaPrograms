...
public class CustomAutomata extends Application {
    ...
    static boolean[] deadStates = new boolean[256], aliveStates = new boolean[256];
    ...
    static void nextGeneration() {
        ...
        checkedCells.forEach(ps -> {
            ...
            String base2 = "";
            base2 += cells.contains((p[0] - 1) + "," + (p[1] - 1)) ? "1" : "0";
            base2 += cells.contains((p[0] - 1) + "," + (p[1])) ? "1" : "0";
            base2 += cells.contains((p[0] - 1) + "," + (p[1] + 1)) ? "1" : "0";
            base2 += cells.contains((p[0]) + "," + (p[1] + 1)) ? "1" : "0";
            base2 += cells.contains((p[0] + 1) + "," + (p[1] + 1)) ? "1" : "0";
            base2 += cells.contains((p[0] + 1) + "," + (p[1])) ? "1" : "0";
            base2 += cells.contains((p[0] + 1) + "," + (p[1] - 1)) ? "1" : "0";
            base2 += cells.contains((p[0]) + "," + (p[1] - 1)) ? "1" : "0";
            int n = Integer.parseInt(base2, 2);
//            n = base2.replace("0", "").length();
